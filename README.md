# Trabalho Final – Python (Kaggle)
**EDA & Storytelling: Clientes de Cartão de Crédito**
...
3) (Se quiser rodar com dados locais) coloque o CSV em `data/` e, no notebook, ajuste o caminho.
